...
let apilink = "https://v6.exchangerate-api.com/v6/369592687323551c6d1498ee/latest/PKR";
//fetching data
...
//conversion rate
let cnv = `https://v6.exchangerate-api.com/v6/369592687323551c6d1498ee/pair/${firstCountry.name}/${secondCountry.name}`;
